...
model = pk.load(open("c:/Users/user/Desktop/ml new/Car_Price_Predictor/notebooks/FC212035_Shenal/model.pkl", "rb"))
...
owner= st.selectbox('Wich Owner', cars_data['owner'].unique())
